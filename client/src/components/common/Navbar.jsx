                    ...
                    <div className="flex w-3/4">
                        ...
                        <div className="block float-right relative w-64">
                            <form action="/tim-kiem" method="get">
                                <input 
                                    className="input input-bordered input-primary border-gainsboro placeholder:text-dark-grey pr-10 pl-5 h-search rounded-full" 
                                    type="text" 
                                    placeholder="Tối thiểu 2 ký tự" name="keywords"/>
                                <button className="absolute right-5 top-0 leading-icon" type="submit" value={"Tìm kiếm"}>
