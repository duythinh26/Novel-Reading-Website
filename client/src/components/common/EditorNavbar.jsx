        ...
        <>
            ...
            {/* <div className="container mx-auto px-[15px] ">
                <div className="mx-[-15px]">
                    <div className="lg:ml-[8.33333333%] lg:w-[83.33333333%] lg:float-left relative min-h-[1px] px-[15px]">
                        <div className="border-[#dddddd] bg-white border rounded shadow-[0_1px_1px_rgba(0,0,0,0.05)] mb-5 border-solid border-transparent">
                            <div className="text-[#333333] bg-neutral-100 px-[15px] py-[10px] rounded-t-[3px] border-b-transparent border-[#dddddd] border-b border-solid">Home</div>
                            <div className="p-[15px]">
                                <h4 className='text-[18px] my-[10px]'>Thống kê</h4>
                                <p className="mt-0 mb-[10px] mx-0">Số truyện: 10</p>
                                <p className="mt-0 mb-[10px] mx-0">Số tập: 0</p>
                                <p className="mt-0 mb-[10px] mx-0">Số chương: 0</p>
                            </div>
                        </div>
                    </div>
                </div>
